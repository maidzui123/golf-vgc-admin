  ...
  return (
    <>
      <li className="relative px-6 py-3" key={route.name}>
        <button
          className="inline-flex items-center justify-between focus:outline-none w-full text-sm font-semibold transition-colors duration-150 hover:text-orange-600 dark:hover:text-gray-200"
            ...
            {route.routes.map((child, i) => (
              <li key={i + 1}>
                ...
                >
                  ...
                  <span className="text-gray-500 hover:text-orange-600 dark:hover:text-gray-200">
                    {t(`${child.name}`)}
                  </span>
                </NavLink>
              </li>
