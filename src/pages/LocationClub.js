...
import LocationClubTable from "components/locationClub/LocationClubTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import LocationClubDrawer from "components/drawer/LocationClubDrawer";
import CheckBox from "components/form/CheckBox";
import useLocationClubFilter from "hooks/useLocationClubFilter";
...
const LocationClubs = () => {
  ...
  } = useLocationClubFilter(data?.products);

  return (
    <>
      <PageTitle>{t("Location's Clubs Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="LocationClubs" />
      <MainDrawer>
        <LocationClubDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search LocationClub"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="LocationClub Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="LocationClub" />
      )}
    </>
  );
};

export default LocationClubs;
