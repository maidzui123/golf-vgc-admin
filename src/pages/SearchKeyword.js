...
import SearchKeywordTable from "components/searchKeyword/SearchKeywordTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import SearchKeywordDrawer from "components/drawer/SearchKeywordDrawer";
import CheckBox from "components/form/CheckBox";
import useSearchKeywordFilter from "hooks/useSearchKeywordFilter";
...
const SearchKeywords = () => {
  ...
  } = useSearchKeywordFilter(data?.products);

  return (
    <>
      <PageTitle>{t("SearchKeywordsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="SearchKeywords" />
      <MainDrawer>
        <SearchKeywordDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search SearchKeyword"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="SearchKeyword Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="SearchKeyword" />
      )}
    </>
  );
};
