...
import PaymentMethodDrawer from "components/drawer/PaymentMethodDrawer";
import CheckBox from "components/form/CheckBox";
import usePaymentMethodFilter from "hooks/usePaymentMethodFilter";
...
const PaymentMethods = () => {
  ...
  } = usePaymentMethodFilter(data?.products);

  return (
    <>
      <PageTitle>{t("PaymentMethodsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="PaymentMethods" />
      <MainDrawer>
        <PaymentMethodDrawer id={serviceId} />
      </MainDrawer>
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="PaymentMethod Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="PaymentMethod" />
      )}
    </>
  );
};
