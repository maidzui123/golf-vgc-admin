...
import RatingDrawer from "components/drawer/RatingDrawer";
...
const Ratings = () => {
  ...
  } = useRatingFilter(data?.products);

  return (
    <>
      <PageTitle>{t("RatingsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="Ratings" />
      <MainDrawer>
        <RatingDrawer id={serviceId} />
      </MainDrawer>
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="Rating Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="Rating" />
      )}
    </>
  );
};
