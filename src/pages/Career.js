...
import useCareerFilter from "hooks/useCareerFilter";
...
const Careers = () => {
  ...
  } = useCareerFilter(data?.products);

  return (
    <>
      <PageTitle>{t("CareersPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="Careers" />
      <MainDrawer>
        <CareerDrawer id={serviceId} />
      </MainDrawer>
