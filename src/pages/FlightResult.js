...
import useFlightResultFilter from "hooks/useFlightResultFilter";
...
const FlightResults = () => {
  ...
  } = useFlightResultFilter(data?.products);

  return (
    <>
      <PageTitle>{t("FlightResultsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="FlightResults" />
      <MainDrawer>
        <FlightResultDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search FlightResult"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="FlightResult Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="FlightResult" />
      )}
    </>
  );
};
