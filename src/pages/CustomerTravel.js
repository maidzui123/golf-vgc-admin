...
import CustomerTravelDrawer from "components/drawer/CustomerTravelDrawer";
import CheckBox from "components/form/CheckBox";
import useCustomerTravelFilter from "hooks/useCustomerTravelFilter";
...
const CustomerTravels = () => {
  ...
  } = useCustomerTravelFilter(data?.products);

  return (
    <>
      <PageTitle>{t("CustomerTravelsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="CustomerTravels" />
      <MainDrawer>
        <CustomerTravelDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search CustomerTravel"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="CustomerTravel Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="CustomerTravel" />
      )}
    </>
  );
};

export default CustomerTravels;
