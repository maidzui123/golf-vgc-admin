...
import SensitiveWordTable from "components/sensitiveWord/SensitiveWordTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import SensitiveWordDrawer from "components/drawer/SensitiveWordDrawer";
...
const SensitiveWords = () => {
  ...
  } = useSensitiveWordFilter(data?.products);

  return (
    <>
      <PageTitle>{t("SensitiveWordsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="SensitiveWords" />
      <MainDrawer>
        <SensitiveWordDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search SensitiveWord"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="SensitiveWord Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="SensitiveWord" />
      )}
    </>
  );
};
