...
import BenefitTable from "components/benefit/BenefitTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import BenefitDrawer from "components/drawer/BenefitDrawer";
import CheckBox from "components/form/CheckBox";
import useBenefitFilter from "hooks/useBenefitFilter";
...
const Benefits = () => {
  ...
  //   })
  // );
  const { data, loading } = useAsync(() => BenefitServices.getAll(queryParams));
  ...
  } = useBenefitFilter(data?.products);

  return (
    <>
      <PageTitle>{t("BENEFITS MANAGEMENT")}</PageTitle>
