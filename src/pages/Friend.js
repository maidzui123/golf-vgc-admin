...
import FriendDrawer from "components/drawer/FriendDrawer";
...
const Friends = () => {
  ...
  } = useFriendFilter(data?.products);

  return (
    <>
      <PageTitle>{t("FriendsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="Friends" />
      <MainDrawer>
        <FriendDrawer id={serviceId} />
      </MainDrawer>
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="Friend Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="Friend" />
      )}
    </>
  );
};
