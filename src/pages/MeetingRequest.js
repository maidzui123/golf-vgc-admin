...
import useMeetingRequestFilter from "hooks/useMeetingRequestFilter";
...
const MeetingRequests = () => {
  ...
  } = useMeetingRequestFilter(data?.products);

  return (
    <>
      <PageTitle>{t("MeetingRequestsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="MeetingRequests" />
      <MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search MeetingRequest"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="MeetingRequest Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="MeetingRequest" />
      )}
    </>
  );
};
