...
import CustomerClubTable from "components/customerClub/CustomerClubTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import CustomerClubDrawer from "components/drawer/CustomerClubDrawer";
import CheckBox from "components/form/CheckBox";
import useCustomerClubFilter from "hooks/useCustomerClubFilter";
...
const CustomerClubs = () => {
  ...
  } = useCustomerClubFilter(data?.products);

  return (
    <>
      <PageTitle>{t("CustomerClubsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="CustomerClubs" />
      <MainDrawer>
        <CustomerClubDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search CustomerClub"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="CustomerClub Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="CustomerClub" />
      )}
    </>
  );
};
