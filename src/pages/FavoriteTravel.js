...
import FavoriteTravelTable from "components/favoriteTravel/FavoriteTravelTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import FavoriteTravelDrawer from "components/drawer/FavoriteTravelDrawer";
import CheckBox from "components/form/CheckBox";
import useFavoriteTravelFilter from "hooks/useFavoriteTravelFilter";
...
const FavoriteTravels = () => {
  ...
  } = useFavoriteTravelFilter(data?.products);

  return (
    <>
      <PageTitle>{t("FavoriteTravelsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="FavoriteTravels" />
      <MainDrawer>
        <FavoriteTravelDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search FavoriteTravel"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="FavoriteTravel Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="FavoriteTravel" />
      )}
    </>
  );
};

export default FavoriteTravels;
