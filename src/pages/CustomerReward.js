...
import CustomerRewardTable from "components/customerReward/CustomerRewardTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import CustomerRewardDrawer from "components/drawer/CustomerRewardDrawer";
import CheckBox from "components/form/CheckBox";
import useCustomerRewardFilter from "hooks/useCustomerRewardFilter";
...
const CustomerRewards = () => {
  ...
  } = useCustomerRewardFilter(data?.products);

  return (
    <>
      <PageTitle>{t("CustomerRewardsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="CustomerRewards" />
      <MainDrawer>
        <CustomerRewardDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search CustomerReward"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="CustomerReward Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="CustomerReward" />
      )}
    </>
  );
};
