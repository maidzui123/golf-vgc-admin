...
import CustomertournamentDrawer from "components/drawer/CustomerTournamentDrawer";
import CheckBox from "components/form/CheckBox";
import useCustomerTournamentFilter from "hooks/useCustomerTournamentFilter";
...
const CustomerTournament = () => {
  ...
  const { data, loading } = useAsync(() =>
    CustomertournamentServices.getAll({
      page: currentPage,
      limit: limitData,
      // category: category,
      title: searchText,
  ...
  } = useCustomerTournamentFilter(data?.products);

  return (
    <>
      <PageTitle>{t("CustomertournamentsPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="Customertournaments" />
      <MainDrawer>
        <CustomertournamentDrawer id={serviceId} />
      </MainDrawer>
          ...
          >
            <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
              <Input
                ...
                type="search"
                name="search"
                placeholder="Search Customertournament"
              />
              <button
                type="submit"
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          ...
          <TableFooter>
            <Pagination
              ...
              label="CustomerTournament Page Navigation"
            />
          </TableFooter>
        </TableContainer>
      ) : (
        <NotFound title="CustomerTournament" />
      )}
    </>
  );
};

export default CustomerTournament;
