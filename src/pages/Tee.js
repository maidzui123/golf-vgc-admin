...
import TeeTable from "components/tee/TeeTable";
import SelectCategory from "components/form/SelectCategory";
import MainDrawer from "components/drawer/MainDrawer";
import TeeDrawer from "components/drawer/TeeDrawer";
import CheckBox from "components/form/CheckBox";
import useTeeFilter from "hooks/useTeeFilter";
...
const Tees = () => {
  ...
  } = useTeeFilter(data?.products);

  return (
    <>
      <PageTitle>{t("TeesPage")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
      <BulkActionDrawer ids={allId} title="Tees" />
      <MainDrawer>
        <TeeDrawer id={serviceId} />
      </MainDrawer>
